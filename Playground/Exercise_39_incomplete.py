...
def rank_cities(df):
    """
    Rank each city each hour from greatest to least (1 is highest) using the "average" method.
    Find the average temperature each hour of the cities with rank 1 through 4.
